...
public interface SettingService {
    ...
    SuccessStatus setSettingProfile(String userEmail, SettingProfileDto dto);
    ...
    SuccessStatus setSettingFoodCategory(String userEmail, SettingFoodCategoryDto dto);
